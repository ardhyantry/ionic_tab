...
export class FoodserviceService {
  pastas = [
    {
      ...
      description:
        'Pasta Spaghetti, Cabai, Paprika Hijau, Bawang Putih dengan Salmon Panggang',
      price: 52000,
      spicy: true,
    },
    {
      ...
      description:
        'Pasta Fettuccine, Daging Ayam Asap, Saus Creamy dengan Chicken Strip dibalur Cream Cheese Mayo dan Beef Bits.',
      price: 35000,
      spicy: false,
    },
    {
      ...
      description:
        'Pasta Fusilli, Pepperoni Sapi, Saus Keju Cheddar, Beef Bits dengan Saus Cheese Fondue',
      price: 38000,
      spicy: false,
    },
    {
      ...
      description:
        'Pasta Penne, Sosis Beef Chorizo,Bayam, Saus Alfredo, dan Truffle Oil',
      price: 42000,
      spicy: false,
    },
    {
      ...
      description:
        'Pasta Spaghetti, Ikan Salmon Fillet, Saus Mayo Mentai, dan Nori.',
      price: 56000,
      spicy: true,
    },
  ];
  ...
  pastaDetail(id: number): Observable<any> {
    return this.http.get(
      'https://ubaya.xyz/hybrid/160422066/pasta_detail.php?id=' + id
    );
  }

  pastaList(filter:string=''): Observable<any> {
    return this.http.get('https://ubaya.xyz/hybrid/160422066/pastas.php?filter=' + filter);
  }
